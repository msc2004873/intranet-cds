    ...
    try {
      const res = await fetch('/api/revisionGlory', {
        ...
        body: JSON.stringify({
          ...
          caja: 'Caja Glory',
          denominaciones,
          datafono_glory: Math.round(totalDatafono),
          efectivo_revisado: Math.round(totalEfectivo),
          sinpe_revisado: Math.round(totalSinpe),
          transferencias_revisadas: Math.round(totalTransf),
          total_revisado: Math.round(totalRevisado),
          total_cajera: Math.round(totalCajera),
          efectivo_cajera: Math.round(totalCajeraEfectivo),
          datafono_cajera: Math.round(totalCajeraBac),
          sinpe_cajera: Math.round(totalCajeraSinpe),
          transferencias_cajera: Math.round(totalCajeraTransf),
