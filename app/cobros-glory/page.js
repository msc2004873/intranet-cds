          ...
          <div style={{ background: 'white', borderRadius: '12px', padding: '28px 24px', maxWidth: '450px', width: '90%', boxShadow: '0 10px 40px rgba(0,0,0,0.2)' }}>
            ...
            <div style={{ marginBottom: '20px' }}>
              ...
              <div style={{ marginBottom: '12px' }}>
                ...
                <input type="text" value={inputMonto === '0' || inputMonto === '' ? '' : (isNaN(parseFloat(inputMonto)) ? inputMonto : parseFloat(inputMonto).toLocaleString('es-CR'))} onChange={(e) => setInputMonto(e.target.value)} inputMode="numeric" style={{ width: '100%', padding: '10px 12px', border: '1.5px solid #E2DDD4', borderRadius: '8px', fontSize: '14px' }} />
              </div>
