      ...
      <div style={{
        ...
        <div style={{
          ...
          <a href="/facturas" style={buttonStyle} onMouseEnter={buttonHoverEnter} onMouseLeave={buttonHoverLeave}>
            ...
            <div style={{ fontSize: '15px', fontWeight: '600', color: '#1A1714', letterSpacing: '-0.2px' }}>Recepción de mercadería</div>
            <div style={{ fontSize: '12px', color: '#6B6560', lineHeight: 1.5 }}>Contá lo que llegó y marcá lo que venga mal</div>
