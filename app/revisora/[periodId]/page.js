    ...
    <div style={{ background: '#fff', border: '1px solid #E2DDD4', borderRadius: '12px', padding: '20px', marginBottom: '16px', overflow: 'hidden' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginBottom: '16px' }}>
        <div>
          ...
          <input type="text" value={bac === '0' || bac === '' ? '' : (isNaN(parseFloat(bac)) ? bac : parseFloat(bac).toLocaleString('es-CR'))} onChange={(e) => setBac(e.target.value)} placeholder="0" inputMode="numeric" style={{ width: '100%', padding: '8px 10px', border: '1.5px solid #E2DDD4', borderRadius: '4px', fontSize: '12px' }} />
        </div>
        <div>
          ...
          <input type="text" value={bn === '0' || bn === '' ? '' : (isNaN(parseFloat(bn)) ? bn : parseFloat(bn).toLocaleString('es-CR'))} onChange={(e) => setBn(e.target.value)} placeholder="0" inputMode="numeric" style={{ width: '100%', padding: '8px 10px', border: '1.5px solid #E2DDD4', borderRadius: '4px', fontSize: '12px' }} />
        </div>
      </div>
