    ...
    <div style={{ background: '#fff', border: '1px solid #E2DDD4', borderRadius: '12px', padding: '20px', marginBottom: '16px', overflow: 'hidden' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginBottom: '16px' }}>
        <div>
          ...
          <input type="text" value={bac === '0' || bac === '' ? '' : (isNaN(parseFloat(bac)) ? bac : parseFloat(bac).toString().replace(/\B(?=(\d{3})+(?!\d))/g, '.'))} onChange={(e) => setBac(e.target.value.replace(/\./g, ''))} inputMode="numeric" style={{ width: '100%', padding: '8px 10px', border: '1.5px solid #E2DDD4', borderRadius: '4px', fontSize: '12px' }} />
        </div>
        <div>
          ...
          <input type="text" value={bn === '0' || bn === '' ? '' : (isNaN(parseFloat(bn)) ? bn : parseFloat(bn).toString().replace(/\B(?=(\d{3})+(?!\d))/g, '.'))} onChange={(e) => setBn(e.target.value.replace(/\./g, ''))} inputMode="numeric" style={{ width: '100%', padding: '8px 10px', border: '1.5px solid #E2DDD4', borderRadius: '4px', fontSize: '12px' }} />
        </div>
      </div>
