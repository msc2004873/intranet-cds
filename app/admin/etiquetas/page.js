...
const TAMANOS = {
  pequena: {
    ...
    ancho:      32,
    alto:       19,
    offsetX:    4,   // ajustar si el contenido sigue corrido a la izquierda en la impresora
    nombre:     { top: 2.5,  left: 1.3, width: 21.3, fontSize: 7   },
    rightCol:   { top: 2.3,  right: 0.3, width: 6.5, logoH: 6.5, gap: 0.8, codFontSize: 7.5 },
    precio:     { top: 9.5,  left: 3,    width: 14,  fontSize: 9.5 },
