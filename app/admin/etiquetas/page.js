...
const TAMANOS = {
  pequena: {
    ...
    barcode:    { top: 13,   left: 4.1, width: 23.8, height: 4.0,  barWidth: 1.2, textSize: 5  },
  },
  grande: {
...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* Barcode — solo barras (sin texto SVG) */
  .barcode {
    position: absolute;
  ...
  /* Número del barcode como HTML puro — no se clipea como SVG text */
  .barcode-num {
    position: absolute;
    top: ${c.barcode.top + c.barcode.height + 0.2}mm;
    left: ${c.barcode.left}mm;
    width: ${c.barcode.width}mm;
